# Integration proposal: rcarmo/python-office-mcp-server
...
- Repository: https://github.com/rcarmo/python-office-mcp-server
- Categories: mcp_server, plugin, tool, workflow
- License: unverified
- Default branch: `main`
...
- documentation: **10/10** — README length 25903
...
A disabled metadata adapter was generated at `generated/adapters/rcarmo-python-office-mcp-server.json`.
