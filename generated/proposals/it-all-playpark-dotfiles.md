# Integration proposal: it-all-playpark/dotfiles
...
- Repository: https://github.com/it-all-playpark/dotfiles
- Categories: skill
- License: unverified
- Default branch: `main`
...
- documentation: **10/10** — README length 5711
...
A disabled metadata adapter was generated at `generated/adapters/it-all-playpark-dotfiles.json`.
