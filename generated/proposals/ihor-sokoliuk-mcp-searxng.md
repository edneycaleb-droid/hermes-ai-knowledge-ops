# Integration proposal: ihor-sokoliuk/mcp-searxng
...
- Categories: mcp_server, memory, plugin, tool
- License: MIT
- Default branch: `main`
...
- documentation: **10/10** — README length 16389
...
- adoption: **10/10** — 1084 stars

## Static security review

- `medium` `SEC008` in `package.json`: Elevated execution or privilege

## Generated implementation

A disabled metadata adapter was generated at `generated/adapters/ihor-sokoliuk-mcp-searxng.json`.
