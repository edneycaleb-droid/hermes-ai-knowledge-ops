# Integration proposal: theoddden/Terradev
...
- Repository: https://github.com/theoddden/Terradev
...
- documentation: **10/10** — README length 25970
...
- `high` `SEC006` in `server.json`: Credential or secret access
- `high` `SEC006` in `.github/workflows/ci.yml`: Credential or secret access

## Generated implementation

A disabled metadata adapter was generated at `generated/adapters/theoddden-terradev.json`.
