# Integration proposal: hillstreet-ph/open-connect
...
- Repository: https://github.com/hillstreet-ph/open-connect
- Categories: agent, api, plugin, skill, tool, workflow
- License: unverified
- Default branch: `main`
...
- documentation: **10/10** — README length 30256
...
A disabled metadata adapter was generated at `generated/adapters/hillstreet-ph-open-connect.json`.
