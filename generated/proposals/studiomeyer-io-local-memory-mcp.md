# Integration proposal: studiomeyer-io/local-memory-mcp
...
- Repository: https://github.com/studiomeyer-io/local-memory-mcp
...
- documentation: **10/10** — README length 30310
...
- `high` `SEC004` in `README.md`: Process execution capability
- `high` `SEC005` in `README.md`: Dynamic code execution

## Generated implementation

A disabled metadata adapter was generated at `generated/adapters/studiomeyer-io-local-memory-mcp.json`.
