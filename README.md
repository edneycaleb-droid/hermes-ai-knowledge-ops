...
Autonomous, review-gated discovery and integration intelligence for Hermes Agent skills, tools, MCP servers, plugins, profiles, cron, and learning-loop capabilities.
